...
public class TurkeyABS203_Test extends Base {
/*       @BeforeTest
    ...
    public void TInsertion_Daily_Success() throws InterruptedException {
        ...
        try {
            ...
            actions.moveToElement(leftmenu.ABS203()).click().build().perform();
            Thread.sleep(2000);
            ...
            //Assert.assertNotEquals(totalproduction, "0");
    ...
    @Test(priority = 3)
    public void CaseAssembly_Daily_Success() throws InterruptedException {
        ...
        try {
            ...
            System.out.println(absline.TabCaseAssembly().getText());
            System.out.println("OEE " + absline.ValueOEE().getText());
            System.out.println("Availability " + absline.ValueAvailability().getText());
            System.out.println("Performance " + absline.ValuePerformance().getText());
            System.out.println("Quality" + absline.ValueQuality().getText());
    ...
    @Test(priority = 7)
    public void CaseAssembly_Weekly_Success() throws InterruptedException {
